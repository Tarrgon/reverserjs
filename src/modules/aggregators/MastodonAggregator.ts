...
class MastodonAggregator implements Aggregator {
  index: number = 53
  manager: AggregationManager

  host: string = "mastodon"
  displayName: string = "Mastodon"
  homepage: string = "https://mastodon.social"

  galleryTemplates: RegExp[] = [
    `mastodon\\.social\\/@${Globals.siteArtistIdentifier}`
  ...
  submissionTemplate: string = "https://mastodon.social/statuses/{siteSubmissionIdentifier}"
  ...
  constructor(manager: AggregationManager) {
    ...
    this.scraper = new MastodonScraper("https://mastodon.social/api/v1")
  }
...
export default MastodonAggregator